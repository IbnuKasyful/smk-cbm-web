...
export const ADMISSION = {
  ...
  // Poster PPDB, 1130 x 1600. Disajikan dari public/images, bukan dari media
  // library WordPress: sejak cutover domain, smkcbm.sch.id melayani front-end
  // ini dan /wp-content/... di sana 404. File aslinya juga tidak ikut termigrasi
  // ke CMS baru, jadi salinan lokal ini adalah satu-satunya sumber.
  posterUrl: '/images/poster-ppdb-2026-2027.jpeg',
  requirements: [
